...
const WRITABLE_SCALAR_FIELDS = ["userId", "transactionId", "orderId", "type", "paymentMethod", "amount", "currency", "fee", "platformFee", "netAmount", "status", "gatewayRef", "gatewayResponse", "customerName", "customerEmail", "customerPhone", "callbackUrl", "metadata", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["user", "events"] as const
