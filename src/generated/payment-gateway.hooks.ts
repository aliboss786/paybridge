...
/**
 * Hooks for PaymentGateway routes
 */
export interface PaymentGatewayHooks {
  /**
...
/**
 * Default PaymentGateway hooks (customize as needed)
 */
export const paymentGatewayHooks: PaymentGatewayHooks = {
