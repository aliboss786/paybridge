...
const WRITABLE_SCALAR_FIELDS = ["email", "name", "passwordHash", "phone", "status", "role", "feePercentage", "balance", "apiRateLimit", "createdAt", "updatedAt"] as const
const RELATION_FIELDS = ["transactions", "ledger", "apiCredentials"] as const
