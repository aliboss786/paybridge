...
/**
 * Hooks for TransactionEvent routes
 */
export interface TransactionEventHooks {
  /**
...
/**
 * Default TransactionEvent hooks (customize as needed)
 */
export const transactionEventHooks: TransactionEventHooks = {
