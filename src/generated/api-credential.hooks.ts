...
/**
 * Hooks for ApiCredential routes
 */
export interface ApiCredentialHooks {
  /**
...
/**
 * Default ApiCredential hooks (customize as needed)
 */
export const apiCredentialHooks: ApiCredentialHooks = {
